                ...
                <div class="modal fade" id="novoUsuarioModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="PHP/inserirProduto.PHP" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control" name="nDesc" id="iDesc" value="" maxlength="80" required="true">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        <label for="iSenha">Preço</label>
                                                        <input type="text" class="form-control form-control" name="nPreco" value="" id="iPreco" maxlength="8" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>	
                                ...
                                <div class="modal-footer">
                                    <a href="products.php" class="btn btn-danger" title="Cancelar a operação">
                                        <span>Cancelar</span>
                                    </a>
